...
class ShippingScreen extends StatelessWidget {
  ...
  Container _addressCard(ShippingModel address, BuildContext context, ShippingController shippingController, int index) {
    return Container(
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text(address.name, style: Get.textTheme.titleMedium),
                    DropdownButtonHideUnderline(
                      child: DropdownButton2<String>(
                        ...
                        items: [
                          DropdownItem<String>(
                            value: 'remove',
                            child: Text("Remove",style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.red),),
                          ),
                          DropdownItem<String>(
                            value: 'default',
                            child: Text("Default",style: Theme.of(context).textTheme.bodyMedium),
                          ),
                        ],
