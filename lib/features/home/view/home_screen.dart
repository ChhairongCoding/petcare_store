...
import 'package:petcare_store/features/home/view/widgets/card_show_widget.dart';
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: CustomScrollView(
            slivers: <Widget>[AppBarWidget(), _buildBody(context)],
          ),
        ),
      ),
    );
                      ...
                      () => Align(
                        ...
                        child: Wrap(
                          ...
                          children: List.generate(
                            isLoading ? 5 : productController.products.length,
                            (index) {
                              final product = isLoading
                                  ? ProductModel.fake()
                                  : productController.products[index];
